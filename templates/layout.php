...
<body <?= !isset($_SESSION['id']) ? 'class="body-background"' : ''; ?>>
<h1 class="visually-hidden">Дела в порядке</h1>

<div class="page-wrapper">
    <div class="container <?= isset($_SESSION['id']) ? 'container--with-sidebar' : ''; ?>">
        <header class="main-header">
            ...
            <div class="main-header__side">
                ...
                <a class="main-header__side-item button button--plus open-modal" href="task.php">Добавить задачу</a>
...
<footer class="main-footer">
    <div class="container">
        ...
        <?php if (isset($_SESSION['id'])): ?>
        <a class="main-footer__button button button--plus" href="task.php">Добавить задачу</a>
        <?php endif; ?>   
